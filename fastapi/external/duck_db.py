...
def create_db_if_not_exist():
    ...
    productive_db.execute("CREATE TABLE IF NOT EXISTS schedules (uuid VARCHAR NOT NULL UNIQUE, fun VARCHAR, started TIMESTAMP, finished TIMESTAMP, success BOOLEAN,  message VARCHAR, stacktrace VARCHAR)")
